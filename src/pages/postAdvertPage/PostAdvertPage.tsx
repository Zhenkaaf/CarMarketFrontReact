...
const PostAdvertPage = () => {
    ...
    if (addPhotosError) {
        ...
        return (
            <Box
                sx={{ fontSize: "24px", fontWeight: "bold", marginTop: "50px" }}
            >
                    ...
                    >
                        ...
                        >
                            ...
                            {CAR_MAKES.map((carMake) => (
                                <MenuItem key={carMake} value={carMake}>
                                    {carMake}
                                </MenuItem>
                            ))}
                        </Select>
